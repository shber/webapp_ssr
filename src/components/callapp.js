...
(function(global, factory) {
  ...
  function buildScheme(config, options) {
	  ...
	  var _options$scheme = options.scheme
	      var host = _options$scheme.host
	      var port = _options$scheme.port
	      var protocol = _options$scheme.protocol
  ...
  function generateIntent(config, options) {
	  ...
	  if (typeof outChain !== 'undefined' && outChain) {
	    var _options$outChain = options.outChain
	        var path = _options$outChain.path
	        var key = _options$outChain.key
  ...
  function generateUniversalLink(config, options) {
	  ...
	  return 'https://' + host + path + urlQuery
  }
	  ...
	  _createClass(CallApp, [{
	    ...
	    value: function open(config) {
	      ...
	      var _options = this.options
	          var universal = _options.universal
	          var appstore = _options.appstore
	          var logFunc = _options.logFunc
	          var intent = _options.intent
	      ...
	      if (browser.isIos) {
	        ...
	        if (browser.isQQ || browser.isQQBrowser) {
	   //    	    document.getElementById('openinBrowsershare').style.backgroundImage="url(https://img.mingchu.co/share.png)";
	        ...
	        // Android
	      	    ...
	      	    // document.getElementById('openinBrowsershare').style.backgroundImage="url(https://img.mingchu.co/shareandroid.png)";
          document.getElementById('openinBrowser').style.display = 'block'
